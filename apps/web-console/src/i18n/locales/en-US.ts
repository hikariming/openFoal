const enUS = {
  ...
  secrets: {
    ...
    workspaceHint: "Leave workspace empty for tenant-wide default. If set, it only applies to that workspace and overrides tenant default.",
    workspaceQuickPick: "Workspace Quick Pick (Optional)",
    workspaceTenantOption: "Tenant Default (empty workspace)",
    workspaceInputPlaceholder: "e.g. w_default; empty = tenant default",
    provider: "Provider",
    modelId: "Model ID",
    baseUrl: "Base URL",
    baseUrlHint: "Base URL is usually the provider's OpenAI-compatible endpoint. If unsure, start with a preset below.",
    baseUrlInputPlaceholder: "e.g. https://api.openai.com/v1",
    apiKey: "API Key",
